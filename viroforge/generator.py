...
def build_parser() -> argparse.ArgumentParser:
    """Build the generation argument parser.

    Single source of truth for generation arguments and their defaults.
    scripts/generate_fastq_dataset.py parses sys.argv with it; the CLI
    calls parse_args([]) to obtain real defaults instead of restating them.
    """
